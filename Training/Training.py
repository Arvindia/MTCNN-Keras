...
'''Last updated on 10/09/2019 02:02'''
...
def minibatch_data_processing(batch_list, AUG_IMG_PATH): 
    ...
    for i in range(EPOCHS):
        ...
        for j in range(num_of_iters):
            ...
            for t in range(thread_num): 
                ...
                cur_thread = CustomThread(minibatch_data_processing, (cur_batch_list, AUG_IMG_PATH)) 
